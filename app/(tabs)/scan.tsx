...
import { View, Text, TouchableOpacity, SafeAreaView, Animated, Platform } from 'react-native';
import { useRouter } from 'expo-router';
import { CameraView, useCameraPermissions } from 'expo-camera';
import * as ImagePicker from 'expo-image-picker';
import { Zap, ZapOff, Image as ImageIcon, History, ScanLine, Camera } from 'lucide-react-native';
  ...
  if (!permission.granted) {
    return (
      ...
      >
        ...
        >
          BAQIR memerlukan akses kamera untuk memindai dan menganalisis kualitas buah Anda.
        </Text>
        <TouchableOpacity
          ...
          >
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                height: 52,
                borderRadius: 16,
                backgroundColor: flashOn ? 'rgba(255,193,7,0.3)' : 'rgba(255,255,255,0.15)',
                alignItems: 'center',
                justifyContent: 'center',
              }}
            >
